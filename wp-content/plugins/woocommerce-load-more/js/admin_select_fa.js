(function ($){
    $(document).ready( function () {
        ...
        $(document).on('click', '.berocket_aapf_select_icon label',function(event) {
            event.preventDefault();
            $(this).parents('.berocket_aapf_select_icon').find('input[type=radio]').prop('checked', false);
            $(this).find('input').prop('checked', true);
            $(this).parents('.berocket_aapf_select_icon').prevAll(".berocket_aapf_icon_text_value").val($(this).find('input').val());
            $(this).parents('.berocket_aapf_select_icon').prevAll(".berocket_aapf_selected_icon_show").html('<i class="fa '+$(this).find('input').val()+'"></i>');
            $(this).parents('.berocket_aapf_select_icon').hide();
        });
